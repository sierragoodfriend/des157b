                ...
                switch (choice) {
                    case 'option1':
                        ...
                        <div class="overlayText">
                            ...
                            <p class="overlayTextP">A 'housing first' approach is the most effective way to decrease homeless rates. <a href="https://calmatters.org/commentary/2019/08/housing/">(Cal Matters)</a></p>
                            <p>Shelters can be housing first institutions if they...</p>
                            <ol>
                                <li>Are easy to access</li>
                                <li>Allow residents to stay 24/7 (not just at night)</li>
                                <li>Focus on assessment and triage</li>
                                <li>Have the goal to connect residents with permanent housing</li>
                            </ol>
                            <p class="overlayTextP">While shelters are important resources, creating and subsizing afforable housing is a better long term solution.</p>
                        </div>`;
